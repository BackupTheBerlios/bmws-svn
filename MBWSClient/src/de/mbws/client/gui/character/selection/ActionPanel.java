...
public class ActionPanel extends JPanel implements PropertyChangeListener {
	...
	private void initialize() {
		...
		characterNameLabel
				.setFont(characterNameLabel.getFont().deriveFont(30F));
		this.setSize(400, 80);
	...
	private JPanel getRightPanel() {
		if (rightPanel == null) {
			...
			l.putConstraint(SpringLayout.EAST, getExitButton(), 5,
					SpringLayout.EAST, rightPanel);
			l.putConstraint(SpringLayout.NORTH, getExitButton(), 5,
	...
	private JButton getExitButton() {
		if (exitButton == null) {
			...
			exitButton.setText(ValueMapper
					.getText(ClientGlobals.CHARACTER_SELECTION_BUTTON_LOGOUT));
