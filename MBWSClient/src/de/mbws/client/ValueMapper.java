...
public class ValueMapper {
	...
	public ValueMapper() {
		super();
		String fileName = "config/LanguageBundle_"
	...
	public static String getRaceName(int raceId) {
		return props.getProperty(new StringBuffer("race.name.").append(raceId)
				.toString());
	}

	public static String getRaceDescription(int raceId) {
		return props.getProperty(new StringBuffer("race.description.").append(
				raceId).toString());
	}
