...
public class CharacterCreationState extends BaseGameState {
	...
	private void setupMenu() {
		...
		//
		// // ((CharacterCreationStateHandler) getInputHandler())
		// // .addPropertyChangeListener(
		// // CharacterCreationStateHandler.CHARACTER_VALIDATION_CHANGE,
		// // actionPanel);
		// desktopPane.add(actionPanel);

		CharacterDetailsPanel cdp = new CharacterDetailsPanel(
				(CharacterCreationStateHandler) getInputHandler());
		// cdp
		// .addPropertyChangeListener((CharacterCreationStateHandler)
		// getInputHandler());
		cdp.setSize(250, desktopPane.getHeight());// - (desktopPane.getHeight() /
		// 3));
