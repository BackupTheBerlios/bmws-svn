...
insert into language_text_mapping (id,text_key,languages_id,text) values (35,'character.selection.button.deletecharacter',1,'Lschen');
...
insert into language_text_mapping (id,text_key,languages_id,text) values (41,'generic.button.back',1,'Zurck');
