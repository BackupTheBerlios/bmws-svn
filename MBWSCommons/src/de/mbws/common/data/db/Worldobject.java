...
public class Worldobject implements Serializable {
    ...
    /** persistent field */
    private de.mbws.common.data.db.WorldobjectType worldobjectType;
    ...
    /** full constructor */
    public Worldobject(Long id, String name, String description, int coordinateX, int coordinateY, int coordinateZ, de.mbws.common.data.db.WorldobjectType worldobjectType, de.mbws.common.data.db.Map map, Set npcWorldobjectMappings, Set characterWorldobjectMappings) {
        this.id = id;
        this.name = name;
    ...
    public de.mbws.common.data.db.WorldobjectType getWorldobjectType() {
        return this.worldobjectType;
    }

    public void setWorldobjectType(de.mbws.common.data.db.WorldobjectType worldobjectType) {
        this.worldobjectType = worldobjectType;
    }
