...
public class NpcStatus implements Serializable {
    ...
    /** full constructor */
    public NpcStatus(Long npcId, String npcstatus, String gamestatus, Integer coordinateX, Integer coordinateZ, Integer currentmana, Integer currenthelth, Integer currentstamina, Integer currentstrength, Integer currentintelligence, Integer currentdexterity, Integer currentconstitution, de.mbws.common.data.db.Npc npc, de.mbws.common.data.db.Map map) {
        this.npcId = npcId;
    ...
    /** minimal constructor */
    public NpcStatus(Long npcId, String npcstatus, de.mbws.common.data.db.Map map) {
        this.npcId = npcId;
        this.npcstatus = npcstatus;
        this.map = map;
    }
