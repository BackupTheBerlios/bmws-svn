...
public class CharacterItemMapping implements Serializable {
    ...
    /** persistent field */
    private de.mbws.common.data.db.Item item;

    /** persistent field */
    private de.mbws.common.data.db.Characterdata characterdata;

    /** full constructor */
    public CharacterItemMapping(Long id, String position, int currentcondition, int depositItem, de.mbws.common.data.db.Item item, de.mbws.common.data.db.Characterdata characterdata) {
        this.id = id;
    ...
    public de.mbws.common.data.db.Item getItem() {
        return this.item;
    }

    public void setItem(de.mbws.common.data.db.Item item) {
        this.item = item;
    }
