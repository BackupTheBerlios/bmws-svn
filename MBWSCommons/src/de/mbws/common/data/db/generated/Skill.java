...
public class Skill implements Serializable {
    ...
    /** persistent field */
    private de.mbws.common.data.db.generated.SkillGroup skillGroup;
    ...
    /** full constructor */
    public Skill(Integer id, String name, byte availableatstartup, Integer oppositeskill, int costhealth, int coststamina, int costmana, int xpcostsbuying, int goldcostsbuying, int xpcostEnhancement, int basevalueFormula, int useDuration, int useTime, de.mbws.common.data.db.generated.SkillGroup skillGroup, Set characterSkillMappings, Set skillRaceMappings, Set npcSkillMappings) {
        this.id = id;
        this.name = name;
    ...
    /** minimal constructor */
    public Skill(Integer id, String name, byte availableatstartup, int costhealth, int coststamina, int costmana, int xpcostsbuying, int goldcostsbuying, int xpcostEnhancement, int basevalueFormula, int useDuration, int useTime, de.mbws.common.data.db.generated.SkillGroup skillGroup, Set characterSkillMappings, Set skillRaceMappings, Set npcSkillMappings) {
        this.id = id;
        this.name = name;
        this.availableatstartup = availableatstartup;
        this.costhealth = costhealth;
    ...
    public de.mbws.common.data.db.generated.SkillGroup getSkillGroup() {
        return this.skillGroup;
    }

    public void setSkillGroup(de.mbws.common.data.db.generated.SkillGroup skillGroup) {
        this.skillGroup = skillGroup;
    }
