...
public class CharacterSkillMapping implements Serializable {
    ...
    /** identifier field */
    private de.mbws.common.data.db.generated.CharacterSkillMappingPK comp_id;
    ...
    /** full constructor */
    public CharacterSkillMapping(de.mbws.common.data.db.generated.CharacterSkillMappingPK comp_id, int bonusvalue, int basevalue, de.mbws.common.data.db.generated.Skill skill, de.mbws.common.data.db.generated.Characterdata characterdata) {
    ...
    /** minimal constructor */
    public CharacterSkillMapping(de.mbws.common.data.db.generated.CharacterSkillMappingPK comp_id, int bonusvalue, int basevalue) {
        this.comp_id = comp_id;
        this.bonusvalue = bonusvalue;
        this.basevalue = basevalue;
    }

    public de.mbws.common.data.db.generated.CharacterSkillMappingPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(de.mbws.common.data.db.generated.CharacterSkillMappingPK comp_id) {
        this.comp_id = comp_id;
    }
