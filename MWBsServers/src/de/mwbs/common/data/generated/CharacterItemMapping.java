...
public class CharacterItemMapping implements Serializable {
    ...
    /** persistent field */
    private de.mwbs.common.data.generated.Item item;

    /** persistent field */
    private de.mwbs.common.data.generated.Characterdata characterdata;

    /** full constructor */
    public CharacterItemMapping(String position, int currentcondition, int depositItem, de.mwbs.common.data.generated.Item item, de.mwbs.common.data.generated.Characterdata characterdata) {
    ...
    public de.mwbs.common.data.generated.Item getItem() {
        return this.item;
    }

    public void setItem(de.mwbs.common.data.generated.Item item) {
        this.item = item;
    }
