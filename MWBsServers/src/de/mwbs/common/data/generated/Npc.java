...
public class Npc implements Serializable {
    ...
    private de.mwbs.common.data.generated.NpcStatus npcStatus;
    ...
    /** full constructor */
    public Npc(Long id, String name, int health, int mana, int stamina, int age, int strength, int intelligence, int dexterity, int constitution, byte isspecial, de.mwbs.common.data.generated.NpcStatus npcStatus, de.mwbs.common.data.generated.Race race, Set npcWorldobjectMappings, Set npcSkillMappings) {
        this.id = id;
        this.name = name;
        this.health = health;
        this.mana = mana;
    ...
    /** minimal constructor */
    public Npc(Long id, String name, int health, int mana, int stamina, int age, int strength, int intelligence, int dexterity, int constitution, byte isspecial, de.mwbs.common.data.generated.Race race, Set npcWorldobjectMappings, Set npcSkillMappings) {
        this.id = id;
        this.name = name;
        this.health = health;
        this.mana = mana;
    ...
    public de.mwbs.common.data.generated.NpcStatus getNpcStatus() {
        return this.npcStatus;
    }

    public void setNpcStatus(de.mwbs.common.data.generated.NpcStatus npcStatus) {
        this.npcStatus = npcStatus;
    }
