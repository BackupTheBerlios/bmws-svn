...
public class CharacterSkillMapping implements Serializable {
    ...
    /** identifier field */
    private de.mwbs.common.data.generated.CharacterSkillMappingPK comp_id;
    ...
    /** full constructor */
    public CharacterSkillMapping(de.mwbs.common.data.generated.CharacterSkillMappingPK comp_id, int bonusvalue, int basevalue, de.mwbs.common.data.generated.Skill skill, de.mwbs.common.data.generated.Characterdata characterdata) {
    ...
    /** minimal constructor */
    public CharacterSkillMapping(de.mwbs.common.data.generated.CharacterSkillMappingPK comp_id, int bonusvalue, int basevalue) {
        this.comp_id = comp_id;
        this.bonusvalue = bonusvalue;
        this.basevalue = basevalue;
    }

    public de.mwbs.common.data.generated.CharacterSkillMappingPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(de.mwbs.common.data.generated.CharacterSkillMappingPK comp_id) {
        this.comp_id = comp_id;
    }
