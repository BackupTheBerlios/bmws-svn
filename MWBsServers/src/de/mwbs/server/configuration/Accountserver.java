...
public class Accountserver implements java.io.Serializable {
    ...
    public Accountserver() 
     {
        super();
    } //-- de.mwbs.server.configuration.Accountserver()
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.mwbs.server.configuration.Accountserver) Unmarshaller.unmarshal(de.mwbs.server.configuration.Accountserver.class, reader);
