...
public class CharacterVisualappearance implements Serializable {
    ...
    /** full constructor */
    public CharacterVisualappearance(Long id, int height, int skinColor, int faceType, int hairColor, int hairStyle, int hairFacial, int itemHead, int itemShoulders, int itemShirt, int itemChest, int itemBelt, int itemLegs, int itemBoots, int itemBracers, int itemGloves, int itemCape, int itemHandLeft, int itemHandRight, de.mbws.server.data.db.generated.Characterdata characterdata) {
        this.id = id;
        this.height = height;
