...
public class NpcWorldobjectMapping implements Serializable {
    ...
    /** identifier field */
    private de.mbws.server.data.db.generated.NpcWorldobjectMappingPK comp_id;
    ...
    /** full constructor */
    public NpcWorldobjectMapping(de.mbws.server.data.db.generated.NpcWorldobjectMappingPK comp_id, de.mbws.server.data.db.generated.Worldobject worldobject, de.mbws.server.data.db.generated.Npc npc) {
    ...
    /** minimal constructor */
    public NpcWorldobjectMapping(de.mbws.server.data.db.generated.NpcWorldobjectMappingPK comp_id) {
        this.comp_id = comp_id;
    }

    public de.mbws.server.data.db.generated.NpcWorldobjectMappingPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(de.mbws.server.data.db.generated.NpcWorldobjectMappingPK comp_id) {
        this.comp_id = comp_id;
    }
