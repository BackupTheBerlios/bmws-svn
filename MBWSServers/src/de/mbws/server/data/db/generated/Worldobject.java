...
public class Worldobject implements Serializable {
    ...
    /** persistent field */
    private de.mbws.server.data.db.generated.WorldobjectType worldobjectType;
    ...
    /** full constructor */
    public Worldobject(Long id, String name, String description, int coordinateX, int coordinateY, int coordinateZ, de.mbws.server.data.db.generated.WorldobjectType worldobjectType, de.mbws.server.data.db.generated.Map map, Set npcWorldobjectMappings, Set characterWorldobjectMappings) {
        this.id = id;
        this.name = name;
    ...
    public de.mbws.server.data.db.generated.WorldobjectType getWorldobjectType() {
        return this.worldobjectType;
    }

    public void setWorldobjectType(de.mbws.server.data.db.generated.WorldobjectType worldobjectType) {
        this.worldobjectType = worldobjectType;
    }
