...
public class CharacterStatus implements Serializable {
    ...
    /** full constructor */
    public CharacterStatus(Long id, String charstatus, String pvp, String gamestatus, int coordinateX, int coordinateY, int coordinateZ, int currentmana, int currenthealth, int currentstamina, int currentstrength, int currentinteligence, int currentdexterity, int currentconstitution, int freexp, de.mbws.server.data.db.generated.Characterdata characterdata, de.mbws.server.data.db.generated.Map map) {
        this.id = id;
    ...
    /** minimal constructor */
    public CharacterStatus(Long id, String charstatus, String pvp, String gamestatus, int coordinateX, int coordinateY, int coordinateZ, int currentmana, int currenthealth, int currentstamina, int currentstrength, int currentinteligence, int currentdexterity, int currentconstitution, int freexp, de.mbws.server.data.db.generated.Map map) {
        this.id = id;
        this.charstatus = charstatus;
        this.pvp = pvp;
        this.gamestatus = gamestatus;
