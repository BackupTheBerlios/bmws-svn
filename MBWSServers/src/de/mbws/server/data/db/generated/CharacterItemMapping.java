...
public class CharacterItemMapping implements Serializable {
    ...
    /** persistent field */
    private de.mbws.server.data.db.generated.Item item;

    /** persistent field */
    private de.mbws.server.data.db.generated.Characterdata characterdata;

    /** full constructor */
    public CharacterItemMapping(Long id, String position, int currentcondition, int depositItem, de.mbws.server.data.db.generated.Item item, de.mbws.server.data.db.generated.Characterdata characterdata) {
        this.id = id;
    ...
    public de.mbws.server.data.db.generated.Item getItem() {
        return this.item;
    }

    public void setItem(de.mbws.server.data.db.generated.Item item) {
        this.item = item;
    }
