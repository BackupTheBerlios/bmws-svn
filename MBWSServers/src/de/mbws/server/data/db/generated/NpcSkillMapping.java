...
public class NpcSkillMapping implements Serializable {
    ...
    /** identifier field */
    private de.mbws.server.data.db.generated.NpcSkillMappingPK comp_id;
    ...
    /** full constructor */
    public NpcSkillMapping(de.mbws.server.data.db.generated.NpcSkillMappingPK comp_id, int value, de.mbws.server.data.db.generated.Skill skill, de.mbws.server.data.db.generated.Npc npc) {
    ...
    /** minimal constructor */
    public NpcSkillMapping(de.mbws.server.data.db.generated.NpcSkillMappingPK comp_id, int value) {
        this.comp_id = comp_id;
        this.value = value;
    }

    public de.mbws.server.data.db.generated.NpcSkillMappingPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(de.mbws.server.data.db.generated.NpcSkillMappingPK comp_id) {
        this.comp_id = comp_id;
    }
