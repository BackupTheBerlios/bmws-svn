...
public class Npc implements Serializable {
    ...
    private de.mbws.server.data.db.generated.NpcStatus npcStatus;
    ...
    /** full constructor */
    public Npc(Long id, String name, int health, int mana, int stamina, int age, int strength, int intelligence, int dexterity, int constitution, byte isspecial, de.mbws.server.data.db.generated.NpcStatus npcStatus, de.mbws.server.data.db.generated.Race race, Set npcWorldobjectMappings, Set npcSkillMappings) {
        this.id = id;
        this.name = name;
        this.health = health;
        this.mana = mana;
    ...
    /** minimal constructor */
    public Npc(Long id, String name, int health, int mana, int stamina, int age, int strength, int intelligence, int dexterity, int constitution, byte isspecial, de.mbws.server.data.db.generated.Race race, Set npcWorldobjectMappings, Set npcSkillMappings) {
        this.id = id;
        this.name = name;
        this.health = health;
        this.mana = mana;
    ...
    public de.mbws.server.data.db.generated.NpcStatus getNpcStatus() {
        return this.npcStatus;
    }

    public void setNpcStatus(de.mbws.server.data.db.generated.NpcStatus npcStatus) {
        this.npcStatus = npcStatus;
    }
