...
public class SkillRaceMapping implements Serializable {
    ...
    /** identifier field */
    private de.mbws.server.data.db.generated.SkillRaceMappingPK comp_id;
    ...
    /** full constructor */
    public SkillRaceMapping(de.mbws.server.data.db.generated.SkillRaceMappingPK comp_id, byte hasonstartup, de.mbws.server.data.db.generated.Skill skill, de.mbws.server.data.db.generated.Race race) {
    ...
    /** minimal constructor */
    public SkillRaceMapping(de.mbws.server.data.db.generated.SkillRaceMappingPK comp_id, byte hasonstartup) {
        this.comp_id = comp_id;
        this.hasonstartup = hasonstartup;
    }

    public de.mbws.server.data.db.generated.SkillRaceMappingPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(de.mbws.server.data.db.generated.SkillRaceMappingPK comp_id) {
        this.comp_id = comp_id;
    }
